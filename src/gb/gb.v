...
wire [7:0] boot_do;
wire [7:0] vram_do;
wire [7:0] vram1_do;  // DMG: tied off below
wire [7:0] zpram_do;
wire [7:0] wram_do;
...
wire [7:0] Savestate_RAMReadData_VRAM0;
wire [7:0] Savestate_RAMReadData_VRAM1;
...
// DMG: no VRAM bank 1
assign vram1_do = 8'h00;
assign Savestate_RAMReadData_VRAM1 = 8'h00;
...
dpram #(13) wram (   // DMG: 8KB, no banking (was #(15) for GBC)
	.clock_a   (clk_cpu),
	.address_a (wram_addr[12:0]),
	.wren_a    (wram_wren),
	.data_a    (cpu_do),
	.q_a       (wram_do),

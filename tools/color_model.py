...
# Both of brickboy's DMG profiles, as brick_color.sv carries them. REAL selects
# between them the way the Panel Colour setting does on hardware.
REAL = False
PAL_N = [(219, 207, 136), (140, 179, 102), (71, 130, 66), (33, 92, 43)]
PBG_N = (237, 217, 149)
PAL_R = [(146, 196, 82), (69, 181, 71), (54, 162, 97), (32, 147, 105)]
PBG_R = (189, 172, 84)
PAL = PAL_R if REAL else PAL_N
PBG = PBG_R if REAL else PBG_N

K_BLEED, K_OFFTINT, K_XTALK = 41, 13, 44
K_XT_GRAY, K_XT_SIGN, K_XT_CLAMP = 102, 56, 166
K_SAT, K_WARM_R, K_WARM_G, K_WARM_B = 218, 8, 2, 6
K_CONTRAST, K_BLACKL = 225, 26
K_BRIGHT = 256 if REAL else 225   # dmg-real needs no lift
